defmodule SymphonyElixir.AgentRunner do
  @moduledoc """
  Executes a single Linear issue in its workspace with a pluggable agent adapter.
  """
  ...
  defp do_run_agent_turns(adapter, app_session, workspace, issue, agent_update_recipient, opts, issue_state_fetcher, turn_number, max_turns) do
  ...
  defp agent_adapter, do: Config.agent_adapter()
end
